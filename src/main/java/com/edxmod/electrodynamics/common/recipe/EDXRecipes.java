...
public class EDXRecipes {
    ...
    private static void addCraftingRecipes() {
        ...
        //Machines
        GameRegistry.addShapedRecipe(new ItemStack(EDXBlocks.tableSieve), "IXI", "SXS", "WWW", 'I', Blocks.wooden_slab, 'X', new ItemStack(EDXItems.component, 1, 1), 'S', new ItemStack(Items.stick), 'W', Blocks.planks);
    }
}
