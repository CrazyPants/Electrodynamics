package com.edxmod.electrodynamics.common.lib.client;
...
public enum EnumParticle {
	...
	public static void ITEM_BREAK(ItemStack stack, World world, double x, double y, double z) {
		...
		for (int i = 0; i < 10; i++) {
			Vec3 vec3 = world.getWorldVec3Pool().getVecFromPool(((double) rand.nextFloat() - 0.5D) * 0.1D, Math.random() * 0.1D + 0.1D, 0.0D);
