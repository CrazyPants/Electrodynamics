package com.edxmod.electrodynamics.common.particle.core;
...
public abstract class ParticleCore extends EntityFX {
    ...
    private static final ResourceLocation texture = new ResourceLocation(EDXProps.RESOURCE_PREFIX + "textures/particles/particles.png");
