 ...
 * @author dmillerw
 */
public class BlockNetherGrass extends EDXBasicBlock {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		side = iconRegister.registerIcon(EDXProps.RESOURCE_PREFIX + "world/netherGrass");
		top = iconRegister.registerIcon(EDXProps.RESOURCE_PREFIX + "world/netherGrass_top");
	}
}
